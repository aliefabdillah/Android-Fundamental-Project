...
import com.dicoding.mynoteapps.ui.adapter.NoteAdapter
import com.dicoding.mynoteapps.ui.insert.NoteAddUpdateActivity

class MainActivity : AppCompatActivity() {
    private var _acitivtyMainBiniding: ActivityMainBinding? = null
    private val binding get() = _acitivtyMainBiniding

    private lateinit var adapter: NoteAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        _acitivtyMainBiniding = ActivityMainBinding.inflate(layoutInflater)
