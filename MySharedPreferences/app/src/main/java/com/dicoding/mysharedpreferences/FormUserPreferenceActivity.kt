...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //mengambil data user pref yang dikirimkan dari main activity dan tipe form nya apakah add atau edit
    ...
    //menampilkan data preference pada layout ketika tipe edit
    ...
    override fun onClick(v: View) {
        if (v.id == R.id.btn_save) {
            ...
            //mengirim data dari form ke activity intent dengan method setResult yang akan diterima oleh resultLaucher
    ...
    //menyimpan nilai data setiap inputan ke dalam preferences
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isLoveMU: Boolean){
        ...
        //meyimpan data menggunakan setUser
        userPreference.setUser(userModel)
        Toast.makeText(this, "Data Saved", Toast.LENGTH_SHORT).show()
    }

    //validasi apakah input email sudah benar
    private fun isValidEmail(email: CharSequence): Boolean {
        return android.util.Patterns.EMAIL_ADDRESS.matcher(email).matches()
    }

    //event ketika tombol back to home ditekan
