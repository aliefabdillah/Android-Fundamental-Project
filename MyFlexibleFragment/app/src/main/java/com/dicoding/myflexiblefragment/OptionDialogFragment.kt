...
/*
* untuk menampilkan sebuah dialog fragment maka harus membuat sebuah class yang inherit ke DialogFragment()*/
class OptionDialogFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btnChoose.setOnClickListener {
            ...
            if (checkedRadioButtonId != -1) {
                ...
                //penggunaan interface untuk handling ketika menekan tombol pilih maka data yang dipilih akan di ambil
                optionDialogListener?.onOptionChosen(coach)
                dialog?.dismiss()                               //option dialog ditutup
            }
        }

        //kondisi memilih close
    ...
    /*Interface untuk handling event ketika tombol pilih pada dialog OptionDialogFragment ditekan*/
