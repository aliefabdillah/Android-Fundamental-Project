...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showNotification(this, getString(R.string.detail_title), getString(R.string.detail_message), 110)
    }
    ...
    private fun showNotification(context: Context, title: String, message: String, notifId: Int){
        ...
        //intent data ke activity detail
        ...
        //pending intent menggnakan taskStacKBUilder
        /*
        Task Stack Builder ini digunakan untuk membuat sebuah back stack baru yang akan dimasukkan
        ke dalam task yang sudah ada. Ketika kelas DetailActivity dijalankan, kemudian pengguna
        menekan tombol back baik itu system back button maupun up button, maka pengguna akan
        diarahkan ke ParentActivity dari DetailActivity
        * */
